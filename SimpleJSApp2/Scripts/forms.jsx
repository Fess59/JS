...
export { CommentInput } from "./components/CommentBlock/CommentInput";
export { CommentItem } from "./components/CommentBlock/CommentItem";

import { default as ProductList } from './components/ProductBlock/ProductList';
import { default as SearchPlugin } from './components/ProductBlock/SearchPlugin';

export { ProductList } from "./components/ProductBlock/ProductList";
export { SearchPlugin } from "./components/ProductBlock/SearchPlugin";
